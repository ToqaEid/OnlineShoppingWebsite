                                    ...
                                    <div class="thumbnail">
                                        ...
                                        <div class="caption">
                                            ...
                                            <h4 style="text-align:center">
                                                <a class="btn" href="ProductDetailsButton?pId=${product.id}"> <i class="icon-zoom-in"></i></a>
                                                <a class="btn" href="EditProductServlet?pId=${product.id}"><i class="icon-edit"></i></a>
                                                <a class="btn" href="RemoveProductButtonServlet?${product.id}"><i class="icon-trash"></i></a>
                                            </h4>
                                        </div>
                                    </div>
                                </li>
