 ...
 * @author Romisaa
 */
@WebServlet(name = "IncreaseCartItem", urlPatterns = {"/IncreaseCartItem"})
public class IncreaseCartItem extends HttpServlet {
...
//            request.setAttribute("success", "Item increased by one.");
        }else{
            request.setAttribute("errorMsg", "No enough quantity in stock for such operation.");
        }
