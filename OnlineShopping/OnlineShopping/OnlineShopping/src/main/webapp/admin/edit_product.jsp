                ...
                <div class="span9">
                    ...
                    <div class="row">	  
                        <div id="gallery" class="span3">
                            ...
                            <form method="post" action="/OnlineShopping/upload2?id=${requestScope.edit_product.id}" enctype="multipart/form-data">
                                <input name="file" type="file" title="&nbsp;" accept="image/*"/>
