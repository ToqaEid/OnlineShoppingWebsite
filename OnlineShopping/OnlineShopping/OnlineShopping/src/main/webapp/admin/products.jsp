			  ...
			  <div class="thumbnail">
				...
				<div class="caption">
				  ...
				  <p> 
				   ...
				   <h4 style="text-align:center"><a class="btn" href="ProductDetailsButton?pId=4"> <i class="icon-zoom-in"></i></a> <a class="btn" href="EditProductServlet?pId=3"><i class="icon-edit"></i></a> <a class="btn" href="RemoveProductButtonServlet?pId=3"><i class="icon-trash"></i></a></h4>
				</div>
			  </div>
			</li>
			<li class="span3">
